          ...
          {loading ? (
            <div className="p-6 space-y-3">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className="h-14 bg-stone-50 rounded-xl animate-pulse"
                />
              ))}
            </div>
          ) : categories.length === 0 ? (
                ...
                <tbody className="divide-y divide-stone-50">
                  {categories.map((cat) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4 hidden sm:table-cell text-stone-400 font-mono text-xs">
                        {cat.slug}
                      </td>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6 space-y-4">
            ...
            <Field
              ...
              value={form.heroAlt as string}
              onChange={set("heroAlt")}
            />
            <Field
              label="OG Image URL"
              field="ogImage"
